    ...
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        <div class="flex flex-col p-4">
            <div class="flex items-center">
                <div class="w-8">
                    <img alt="profile image for user" class="w-8 h-8 object-cover rounded-full"
        ...
        <div class="w-full">
            <img alt="post image" class="w-full"
                 src="https://pbs.twimg.com/media/EHVk3TRU0AAWb80?format=jpg&name=4096x4096">
        </div>
        ...
        <div class="px-4 flex justify-between text-gray-700 text-sm pt-2">
            <div class="flex">
                ...
                <p>Jame Smooth and 1328 others</p>
            </div>
